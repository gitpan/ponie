...
Ap	|HE***	|macro_HvARRAY	|HV *
Ap	|STRLEN*	|macro_HvFILL	|HV *
Ap	|STRLEN*	|macro_HvMAX	|HV *
Ap	|I32*	|macro_HvRITER	|HV *
Ap	|HE**	|macro_HvEITER	|HV *
Ap	|PMOP**	|macro_HvPMROOT	|HV *
...
Ap	|STRLEN*	|macro_SvCUR	|SV *
Ap	|STRLEN*	|macro_SvLEN	|SV *
Ap	|IV*	|macro_SvIVX	|SV *
Ap	|NV*	|macro_SvNVX	|SV *
...
Ap	|SV**	|macro_SvRV	|SV *
Ap	|U8*	|macro_BmRARE	|SV *
Ap	|I32*	|macro_BmUSEFUL	|SV *
Ap	|U16*	|macro_BmPREVIOUS	|SV *
Ap	|IV*	|macro_FmLINES	|SV *
Ap	|PerlIO**	|macro_IoIFP	|SV *
Ap	|PerlIO**	|macro_IoOFP	|SV *
Ap	|DIR**	|macro_IoDIRP	|SV *
Ap	|void**	|macro_IoANY	|SV *
Ap	|IV*	|macro_IoLINES	|SV *
Ap	|IV*	|macro_IoPAGE	|SV *
Ap	|IV*	|macro_IoPAGE_LEN	|SV *
Ap	|IV*	|macro_IoLINES_LEFT	|SV *
Ap	|char**	|macro_IoTOP_NAME	|SV *
Ap	|GV **	|macro_IoTOP_GV	|SV *
Ap	|char**	|macro_IoFMT_NAME	|SV *
Ap	|GV**	|macro_IoFMT_GV	|SV *
Ap	|char**	|macro_IoBOTTOM_NAME	|SV *
Ap	|GV**	|macro_IoBOTTOM_GV	|SV *
