...
PERL_CALLCONV HE***	Perl_macro_HvARRAY(pTHX_ HV *);
PERL_CALLCONV STRLEN*	Perl_macro_HvFILL(pTHX_ HV *);
PERL_CALLCONV STRLEN*	Perl_macro_HvMAX(pTHX_ HV *);
PERL_CALLCONV I32*	Perl_macro_HvRITER(pTHX_ HV *);
PERL_CALLCONV HE**	Perl_macro_HvEITER(pTHX_ HV *);
PERL_CALLCONV PMOP**	Perl_macro_HvPMROOT(pTHX_ HV *);
...
PERL_CALLCONV STRLEN*	Perl_macro_SvCUR(pTHX_ SV *);
PERL_CALLCONV STRLEN*	Perl_macro_SvLEN(pTHX_ SV *);
PERL_CALLCONV IV*	Perl_macro_SvIVX(pTHX_ SV *);
PERL_CALLCONV NV*	Perl_macro_SvNVX(pTHX_ SV *);
PERL_CALLCONV UV*	Perl_macro_SvUVX(pTHX_ SV *);
PERL_CALLCONV MAGIC**	Perl_macro_SvMAGIC(pTHX_ SV *);
PERL_CALLCONV HV**	Perl_macro_SvSTASH(pTHX_ SV *);
PERL_CALLCONV char*	Perl_macro_LvTYPE(pTHX_ SV *);
PERL_CALLCONV SV**	Perl_macro_LvTARG(pTHX_ SV *);
PERL_CALLCONV STRLEN*	Perl_macro_LvTARGLEN(pTHX_ SV *);
PERL_CALLCONV STRLEN*	Perl_macro_LvTARGOFF(pTHX_ SV *);
PERL_CALLCONV SV**	Perl_macro_SvRV(pTHX_ SV *);
PERL_CALLCONV U8*	Perl_macro_BmRARE(pTHX_ SV *);
PERL_CALLCONV I32*	Perl_macro_BmUSEFUL(pTHX_ SV *);
PERL_CALLCONV U16*	Perl_macro_BmPREVIOUS(pTHX_ SV *);
PERL_CALLCONV IV*	Perl_macro_FmLINES(pTHX_ SV *);
PERL_CALLCONV PerlIO**	Perl_macro_IoIFP(pTHX_ SV *);
PERL_CALLCONV PerlIO**	Perl_macro_IoOFP(pTHX_ SV *);
PERL_CALLCONV DIR**	Perl_macro_IoDIRP(pTHX_ SV *);
PERL_CALLCONV void**	Perl_macro_IoANY(pTHX_ SV *);
PERL_CALLCONV IV*	Perl_macro_IoLINES(pTHX_ SV *);
PERL_CALLCONV IV*	Perl_macro_IoPAGE(pTHX_ SV *);
PERL_CALLCONV IV*	Perl_macro_IoPAGE_LEN(pTHX_ SV *);
PERL_CALLCONV IV*	Perl_macro_IoLINES_LEFT(pTHX_ SV *);
PERL_CALLCONV char**	Perl_macro_IoTOP_NAME(pTHX_ SV *);
PERL_CALLCONV GV **	Perl_macro_IoTOP_GV(pTHX_ SV *);
PERL_CALLCONV char**	Perl_macro_IoFMT_NAME(pTHX_ SV *);
PERL_CALLCONV GV**	Perl_macro_IoFMT_GV(pTHX_ SV *);
PERL_CALLCONV char**	Perl_macro_IoBOTTOM_NAME(pTHX_ SV *);
PERL_CALLCONV GV**	Perl_macro_IoBOTTOM_GV(pTHX_ SV *);
