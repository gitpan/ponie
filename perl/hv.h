...
#define HvFILL(hv)          (* Perl_macro_HvFILL   (aTHX_ (HV*)(hv)) )
#define HvMAX(hv)           (* Perl_macro_HvMAX    (aTHX_ (HV*)(hv)) )
#define HvRITER(hv)         (* Perl_macro_HvRITER  (aTHX_ (HV*)(hv)) )
#define HvEITER(hv)         (* Perl_macro_HvEITER  (aTHX_ (HV*)(hv)) )
