...
#define SvRV(sv) (* Perl_macro_SvRV(aTHX_ (SV*) (sv)))
#define SvRVx(sv) SvRV(sv)

#define SvIVX(sv) (* Perl_macro_SvIVX(aTHX_ (SV*) (sv)))
#define SvUVX(sv) (* Perl_macro_SvUVX(aTHX_ (SV*) (sv)))
#define SvNVX(sv) (* Perl_macro_SvNVX(aTHX_ (SV*) (sv)))
...
#define SvCUR(sv) ( * Perl_macro_SvCUR(aTHX_ (SV*) (sv)))
#define SvLEN(sv) ( * Perl_macro_SvLEN(aTHX_ (SV*) (sv)))
#define SvLENx(sv) SvLEN(sv)
#define SvEND(sv)(SvPVX(sv) + SvCUR(sv))
#define SvENDx(sv) ((PL_Sv = (sv)), SvEND(PL_Sv))
#define SvMAGIC(sv)	(* Perl_macro_SvMAGIC(aTHX_ (SV*) (sv)))
#define SvSTASH(sv)	(* Perl_macro_SvSTASH(aTHX_ (SV*) (sv)))
...
#define BmPREVIOUS(sv)	(* Perl_macro_BmPREVIOUS(aTHX_ (SV*)(sv)))
...
#define IoIFP(sv)	( * Perl_macro_IoIFP(aTHX_ (SV*)(sv)))
#define IoOFP(sv)	( * Perl_macro_IoOFP(aTHX_ (SV*)(sv)))
#define IoDIRP(sv)	( * Perl_macro_IoDIRP(aTHX_ (SV*)(sv)))
#define IoANY(sv)	( * Perl_macro_IoANY(aTHX_ (SV*)(sv)))
#define IoLINES(sv)	( * Perl_macro_IoLINES(aTHX_ (SV*)(sv)))
#define IoPAGE(sv)	( * Perl_macro_IoPAGE(aTHX_ (SV*)(sv)))
#define IoPAGE_LEN(sv)	( * Perl_macro_IoPAGE_LEN(aTHX_ (SV*)(sv)))
#define IoLINES_LEFT(sv)( * Perl_macro_IoLINES_LEFT(aTHX_ (SV*)(sv)))
#define IoTOP_NAME(sv)	( * Perl_macro_IoTOP_NAME(aTHX_ (SV*)(sv)))
#define IoTOP_GV(sv)	( * Perl_macro_IoTOP_GV(aTHX_ (SV*)(sv)))
#define IoFMT_NAME(sv)	( * Perl_macro_IoFMT_NAME(aTHX_ (SV*)(sv)))
#define IoFMT_GV(sv)	( * Perl_macro_IoFMT_GV(aTHX_ (SV*)(sv)))
#define IoBOTTOM_NAME(sv)( * Perl_macro_IoBOTTOM_NAME(aTHX_ (SV*)(sv)))
#define IoBOTTOM_GV(sv)	( * Perl_macro_IoBOTTOM_GV(aTHX_ (SV*)(sv)))
#define IoSUBPROCESS(sv)( * Perl_macro_IoSUBPROCESS(aTHX_ (SV*)(sv)))
#define IoTYPE(sv)	( * Perl_macro_IoTYPE(aTHX_ (SV*)(sv)))
#define IoFLAGS(sv)	( * Perl_macro_IoFLAGS(aTHX_ (SV*)(sv)))
